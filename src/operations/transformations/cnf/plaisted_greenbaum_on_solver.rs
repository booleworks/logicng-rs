...
fn add_cnf_to_solver_internal<B>(
    ...
    let working_formula = if config.perform_nnf || contains_pbc(formula, f) {
        f.nnf_of(formula)?
    } else {
        formula
    };
...
fn handle_equiv<B>(
    ...
    if was_cached {
        ...
        .unwrap();
        let mut left_neg = compute_transformation(
            equiv.left(f).unwrap(),
            proposition.clone(),
            solver,
            f,
        ...
        .unwrap();
        let right_pos = compute_transformation(
            equiv.right(f).unwrap(),
            proposition.clone(),
            solver,
            f,
            cache,
        ...
        .unwrap();
        let right_neg = compute_transformation(
            equiv.right(f).unwrap(),
            proposition.clone(),
            solver,
            f,
...
fn handle_impl<B>(
    ...
    if was_cached {
        ...
        let mut left = compute_transformation(
            implication.left(f).unwrap(),
            proposition.clone(),
            solver,
            f,
            cache,
        ...
        .unwrap();
        let right = compute_transformation(
            implication.right(f).unwrap(),
            proposition,
            solver,
            f,
            cache,
        ...
        let left = compute_transformation(
            implication.left(f).unwrap(),
            proposition.clone(),
            solver,
            f,
